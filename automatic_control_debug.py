...
from basic_agent_with_detector import BasicAgent
...
class World(object):
    ...
    def restart(self, args):
        ...
        blueprint = blueprint_list[0]#random.choice(blueprint_list)
...
class CameraManager(object):
    ...
    def update_bounding_boxes(self, bbox_data):
        print('BBox Data Updated')
        print('Updating bounding boxes:', bbox_data)
    ...
    def project_to_camera_pygame(self, bbox):
        print('Projecting BBoxes to Camera')
