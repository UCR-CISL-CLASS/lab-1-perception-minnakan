...
def project_3d_pt(pt, cam_to_img, calib_file=None):
    ...
    point_3d = point
    point_3d = point_3d.astype(np.int16)
...
def plot_3d_pts(img, pts, center, calib_file=None, cam_to_img=None, relative=False, constraint_idx=None):
    ...
    for pt in pts:
        ...
        point, point_3d = project_3d_pt(pt, cam_to_img)
...
def plot_3d_box(img, cam_to_img, ry, dimension, center):
    ...
    for corner in corners:
        point, point_3d = project_3d_pt(corner, cam_to_img)
        box_3d.append(point)
        box_3d_no_proj.append(point_3d)
